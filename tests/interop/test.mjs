...
run(`cd ${__dir} && node_modules/.bin/tsp compile ${__dir}/alltypes.tsp --emit=@specodec/typespec-emitter-dart \
...
dependencies:
  specodec:
    git:
      url: http://10.199.64.20:30000/specodec/specodec-runtime-dart.git
      ref: main
  path: ^1.8.0
`;
